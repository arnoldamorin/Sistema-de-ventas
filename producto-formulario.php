...
if(isset($_GET["id"]) && $_GET["id"] > 0 ){
    ...
    function nombreTipoProducto($fk){  
    foreach ($aTipoProducto as $elemento):
        if($fk == $elemento->idtipoproducto){
            ...
            <div class="col-6 form-group">
                ...
                <select class="form-control selectpicker" id="lstTipoProducto" name="lstTipoProducto" data-live-search="true" value="">
                    ...
                    <?php foreach ($aTipoProducto as $tipoproducto):
                        if(isset($_GET["id"])&& $_GET["id"] > 0 ){
                            if($aTipoProducto->idtipoproducto == $_GET["id"]){?>                         
                                <option selected value=""><?php echo $tipoproducto->nombre;?></option>                      
                            <?php }}else ?>
                        <option><?php echo $tipoproducto->nombre;?></option>
                    <?php endforeach;?>                 
                </select>        
            </div>      
            <div class="col-6 form-group">
